...
#include "PxiiGA_MeleeAttack.generated.h"

/**
 * 
 */
UCLASS()
class PXII_API UPxiiGA_MeleeAttack : public UPxiiGA_OneshotBase
{
	GENERATED_BODY()

public:
	explicit UPxiiGA_MeleeAttack(const FObjectInitializer& ObjectInitializer);
	...
	TSubclassOf<UGameplayEffect> GE_ComboWindow;
};
